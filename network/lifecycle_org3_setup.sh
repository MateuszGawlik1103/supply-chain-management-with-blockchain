...
export CORE_PEER_TLS_ROOTCERT_FILE="$CORE_PEER_TLS_ROOTCERT_FILE_ORG3"

export FABRIC_CA_CLIENT_HOME="${PWD}/organizations/peerOrganizations/org3.example.com"

export CORE_PEER_MSPCONFIGPATH="${PWD}/organizations/peerOrganizations/org3.example.com/users/${USER}@org3.example.com/msp"
