...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    createOrg org1 example.com 7054 ca-org1

    infoln "Creating Org2 Identities"

    createOrg org2 example.com 8054 ca-org2

    infoln "Creating Orderer Org Identities"

    createOrg org3 example.com 6054 ca-org3
...
function networkUp() {
  ...
  infoln "Compose file base in networkUp function"
